...
{
    /**
     * @var \JoeDixon\Translation\Drivers\File
     */
    private $translation;
    ...
    public function index(Request $request, $language)
    {
        ...
        $groups = $this->translation->getGroupsFor($default_language)->merge('single');
        ...
        //dump($this->translation->allTranslations());

        return view('translation::languages.translations.index',
            compact('language', 'default_language', 'languages', 'groups', 'translations')
        );
    }
